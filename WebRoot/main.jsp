                        ...
                        <div id="bs_bannerright">
                            ...
                            <div class="bs_nav">
                                ...
                                <div class="bs_navright">
                                	<span class="icon_no hand"><%=userName.toString() %>&nbsp;欢迎您</span>
                                	<span class="icon_no hand"><a href="LoginServlet?action=logout" target="_top">退出</a></span>
                                    <div class="clear">
                                    </div>
                                </div>
                                <div class="clear">
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                        	<!-- 这个标签可以导入其他其他页面 -->
                                            <IFRAME scrolling="yes" width="1000px" frameBorder="0" id="frmleft" name="frmleft" src="leftPages/accordition.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="auto" height="100%" width="100%" frameBorder="0" id="frmright" name="frmright" src="mainBack.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
