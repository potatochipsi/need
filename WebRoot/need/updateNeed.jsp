						...
						<table class="table" border="2" cellpadding="10">
							...
							<tr class="form-group">
								...
								<td colspan="5"><input type="text" id="guanli"
									name="guanli" value="${need.guanli}" ></td>

							</tr>
							<tr class="form-group">
								<td><strong style="color: red;">*</strong>通讯地址</td>
								<td><input type="text" id="address" name="address"
									value="${need.address}"></td>
								<td>所在地域</td>
							...
							<tr class="form-group">
								<td>网址</td>
								<td><input type="text" id="web" name="web" value="${need.web}" autofocus /></td>
							...
							<tr class="form-group">
								<td colspan="5"><textarea class="textarea"
										...
										name="jigoujianjie" cols=100 rows=6 value="${need.jigoujianjie}"></textarea></td>
							</tr>
							<tr class="tr1">
								<td><strong style="color: red;">*</strong>技术需求名称</td>
								<td><input type="text" id="jishuname" name="jishuname" value="${need.jishuname}"></td>
								<td>需求年限</td>
							...
							<tr class="form-group">
								<td colspan="5"><textarea class="textarea"
										...
										name="main" cols=100 rows=6 value="${need.theme}"></textarea></td>
							</tr>
							<tr>
								<td>*关键字:</td>
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form 
					action="${pageContext.request.contextPath }/Xuiqu/add.action?id=${UserBean.id }"
					method="post" id="checkForm">
					<div class="modal-body">
