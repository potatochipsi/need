	...
	<table border="1" align="center">
		...
		<c:forEach var="tec" items="${tecs }">
			<tr align="center"  height="24px">
				...
				<td width="120">
					<a href="tecQxx.action?param=0&tname=${tec.tid}">查看</a>&nbsp;&nbsp;
					<a href="../tecTJ.action?param=0&tname=${tec.tid}">提交</a>&nbsp;&nbsp;
					<a href="../tecQuery2.action?param=0&tname=${tec.tid}">编辑</a>&nbsp;&nbsp;
					<a href="tecDelete.action?param=0&tname=${tec.tid}">删除</a>&nbsp;&nbsp;
				</td>
			</tr>
		</c:forEach>
</table>
