...
<body>	
  ...
  <tr>
    ...
    <td colspan="2">${tec.tcooperate }
    </tr>
  <tr>
    <td height="50" >合作意向单位：</td>
    <td colspan="2">${tec.tcompany }</td>
  </tr>
  <tr>
    <td>科技活动类型：<i class="red">*</i></td>
    <td colspan="2">${tec.tnature }
