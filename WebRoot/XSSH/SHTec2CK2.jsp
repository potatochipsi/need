...
<input name="param" type="hidden" value="1">
  ...
  <input type="hidden" name="tec.sh" value="技术审核不通过">
  <input type="hidden" name="tec.bm" value="<s:property value="#st.bm"/>">
  <input type="hidden" name="tec.csry" value="<s:property value="#st.csry"/>">
  <input type="hidden" name="tec.zsry" value="${user.cid }">
		<table  width="1050" height="539" border="3" align="center" align="center" class="STYLE3">
		<tr>
		  <td height="60" colspan="9"><div align="left"><span class="STYLE2">技术审核不通过 <a class="STYLE22">(带<i class="red"> * </i>号的为必填项,信息为以后使用,请认真填写.)</a></span> </div>
	      </td>
  </tr>
  <tr>
  <td colspan="4">
